         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card card-primary">
                  ...
                  @endif
                  <form id="quickForm" action="{{route('about_us.update')}}" method="POST" enctype="multipart/form-data">
                     {{csrf_field()}}
                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                           ...
                           <textarea name="long_description" id="long_description" class="form-control">{{$result->long_description}}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           @if(!empty($result->image))
                              <img src="{{ url('/public/admin/clip-one/assets/about_us') }}/{{$result->image}}" width="100px">
                           @endif
                        </div>
                              ...
                              @if (count($images)>0)
                                ...
                                @foreach($images as $productImage)
                                 <div class="custom_close">
                                    <img src="{{ asset('/public/admin/clip-one/assets/about_us/thumbnail')}}/{{ $productImage->image }}" alt="" class="product-edit-img"> 
                     ...
                     <div class="card-footer">
                        <div>
                           ...
                           <a href="{{route('about_us.index')}}" class="btn btn-default btn-secondary">Back</a>
                        </div>
                     </div>
                  </form>
               </div>
...
<script>
   $(document).ready(function(){
     $('.product-edit-btn').on('click',function(){
         ...
         $.ajax({
             url: "{{ url('admin/about_us/image/delete') }}/"+id,
             method: "get",
