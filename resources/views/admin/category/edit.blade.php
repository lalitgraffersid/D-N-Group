         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card card-primary">
                  ...
                  @endif
                  <form id="quickForm" action="{{route('category.update')}}" method="POST" enctype="multipart/form-data">
                     {{csrf_field()}}
                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           @if (!empty($result->image))
                              <img src="{{ asset('/public/admin/clip-one/assets/category/thumbnail') }}/{{$result->image}}" alt="" class="product-edit-img">
                           @endif
