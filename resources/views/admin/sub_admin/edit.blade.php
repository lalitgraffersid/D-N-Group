            ...
            <div class="col-lg-12"> 
              ...
              @endif
               ...
               <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form id="quickForm" role="form" action="{{ route('sub_admin.update') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                 {{csrf_field()}}
                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="name" value="{{$user->name}}" class="form-control" id="sub_admin" placeholder="Enter  Name" autocomplete="off" />
                        </div>
                        <div class="form-group">
                           <label for="user_email">Email</label>
                           <input type="email" name="email" value="{{$user->email}}" class="form-control" id="user_email" placeholder="Enter Email" autocomplete="off" />
                        </div>
                        <div class="form-group">
                                 ...
                                 <div class="form-group clearfix" style="padding-left: 20px;">
                                    ...
                                    <input type="hidden" name="role_id{{$i}}" value="{{$rol->id}}">
                                       ...
                                       foreach($action_id as $actid){
                                          ...
                                          <div class="d-inline">
                                             <input type="checkbox" id="checkbox_{{$i}}" name="action_id{{$i}}[]" value="{{$actions->action_slug}}" <?php if(in_array($actions->action_slug, $adminAction)){echo "checked";} ?>>
