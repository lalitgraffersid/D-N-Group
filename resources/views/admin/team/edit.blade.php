         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card card-primary">
                  ...
                  @endif
                  <form id="quickForm" action="{{route('team.update')}}" method="POST" enctype="multipart/form-data">
                     {{csrf_field()}}
                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="email" value="{{$result->email}}" class="form-control" id="email" placeholder="Email">
                        </div>
                        <div class="form-group">
                           <label for="phone">Phone</label>
                           <input type="text" name="phone" value="{{$result->phone}}" class="form-control" id="phone" placeholder="Phone">
                        </div>

                        <div class="form-group">
                           <label for="designation">Designation</label>
                           <input type="text" name="designation" value="{{$result->designation}}" class="form-control" id="designation" placeholder="Designation">
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           @if (!empty($result->image))
                              <img src="{{ asset('/public/admin/clip-one/assets/team/thumbnail') }}/{{$result->image}}" alt="" class="product-edit-img">
                           @endif
