					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-7" style="border-right: solid #666 1px;">
								...
								<div class="row">
									<div class="col-lg-6">
										<img src="{{asset('assets/front/images/ftr-logo1.png')}}" alt="" class="img-fluid" width="240">
									</div>


									<div class="col-lg-6">
										<img src="{{asset('assets/front/images/ftr-logo2.png')}}" alt="" class="img-fluid" width="240">
									</div>
								</div>
							</div>
							...
							<ul class="address-list">
								<li>{{$set->address}}</li>
								<li>Call - {{$set->phone}}</li>
								<li>Email - {{$set->email}}</li>
							</ul>
							<a href="{{$set->facebook_link}}"><img src="{{asset('assets/front/images/fb.png')}}" alt=""></a> &nbsp;
							<a href="{{$set->tw_link}}"><img src="{{asset('assets/front/images/tw.png')}}" alt=""></a> &nbsp;
							<a href="{{$set->instagram_link}}"><img src="{{asset('assets/front/images/insta.png')}}" alt=""></a> &nbsp;
							<a href="{{$set->ln_link}}"><img src="{{asset('assets/front/images/in.png')}}" alt=""></a>
							</div>
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<ul class="copy-links">
									...
									<li><a href="{{route('energy')}}">Energy Solutions</a></li>
...
<script src="{{asset('assets/front/js/stellarnav.min.js')}}"></script>
