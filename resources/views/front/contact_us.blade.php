...
<div class="container">
 ...
 {{$setting->address}}<br>
  <strong>Phone:</strong><br>Office - <a href="callto:{{$setting->phone}}">{{$setting->phone}}</a>, Eddie - <a href="callto:087 668 7739">087 668 7739</a>,  Brian - <a href="callto:087 965 4916">087 965 4916</a><br>
  <strong>Email:</strong><br><a href="mailto:{{$setting->email}}">{{$setting->email}}</a>
