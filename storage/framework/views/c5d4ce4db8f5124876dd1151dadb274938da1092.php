							...
							<div class="col-lg-3">
								<div class="our-team-box">
									...
									<div class="team-text get-services-text">
										...
										<a href="<?php echo e(route('servicedetail',$pro->id)); ?>">Read More</a>
									</div>
								</div>
							</div>
...
<?php echo $__env->make('front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\get_solutions\resources\views/front/service/index.blade.php ENDPATH**/ ?>