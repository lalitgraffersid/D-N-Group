                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" name="tw_link" value="<?php echo e($result->tw_link); ?>" class="form-control" id="instagram_link" >
                              </div>
                           </div>
                             ...
                             <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="ln_link" value="<?php echo e($result->ln_link); ?>" class="form-control" id="instagram_link" >
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/get-solutionweb/resources/views/admin/setting/index.blade.php ENDPATH**/ ?>