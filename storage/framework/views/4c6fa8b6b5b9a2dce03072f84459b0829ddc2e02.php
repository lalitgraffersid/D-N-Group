...
?>
 <div class="footer-main">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 footer-col-dark">
              ...
              <p class="footer-text">Founded by Eddie Doyle and Brian Nugent in 2006 as D&N Electrical, the company
                ...
                <ul class="social-list">
                  <li><a href="<?php echo e($set->facebook_link); ?>" target="blank"><i class="fa fa-facebook fa-size fb-bg"></i></a></li>
                  <li><a href="<?php echo e($set->instagram_link); ?>" target="blank"><i class="fa fa-instagram fa-size insta-bg"></i></a></li>
                </ul>
    ...
    <script src="<?php echo e(asset('assets/front/js/owl-script.js')); ?>"></script>
    <script>
      function myFunction() {
...
<?php /**PATH /home/hm3hczr3zv0q/public_html/demo/DNGroup/resources/views/front/includes/footer.blade.php ENDPATH**/ ?>