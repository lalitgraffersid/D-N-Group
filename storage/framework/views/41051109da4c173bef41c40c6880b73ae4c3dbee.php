              ...
              <div class="card">
               <?php if(!empty($data['checkRole']) && (Auth::user()->user_type == 'admin' || !empty($data['checkPermission']))): ?>
                  <div class="card-header float-right">
                     <a href="<?php echo e(route('sub_admin.add')); ?>" class="btn btn-info float-right"><i class="fas fa-plus"></i> Add Sub Admin</a>
                  </div>
               <?php endif; ?>
              <!-- /.card-header -->
              <div class="card-body">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fjs_plant\resources\views/admin/sub_admin/index.blade.php ENDPATH**/ ?>