...
<!-- Brand Logo -->
   <a href="#" class="brand-link">
      <img src="<?php echo e(asset('assets/admin/dist/img/AdminLTELogo.png')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">A1 Solutions</span>
   </a>
 ...
 <?php /**PATH C:\xampp\htdocs\a1_solutions\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>