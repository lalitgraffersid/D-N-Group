         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card card-primary">
                  ...
                  <?php endif; ?>
                  <form id="quickForm" action="<?php echo e(route('gallery.save')); ?>" method="POST" enctype="multipart/form-data">
...
$(function () {
   $('#quickForm').validate({
      ...
      messages: {
         ...
         before_image: {
            required: "Please upload before image",
         },
         after_image: {
            required: "Please upload after image",
         },
      },
      errorElement: 'span',
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\a1_solutions\resources\views/admin/gallery/add.blade.php ENDPATH**/ ?>