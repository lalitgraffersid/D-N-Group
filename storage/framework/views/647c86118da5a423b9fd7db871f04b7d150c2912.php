         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card card-primary">
                  ...
                  <?php endif; ?>
                  <form id="quickForm" action="<?php echo e(route('sponsorship.update')); ?>" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           <?php if(!empty($result->image)): ?>
                              <img src="<?php echo e(url('/public/admin/clip-one/assets/sponsorship')); ?>/<?php echo e($result->image); ?>" width="100px">
                           <?php endif; ?>
                        </div>
                              ...
                              <?php if(count($images)>0): ?>
                                ...
                                <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <div class="custom_close">
                                    <img src="<?php echo e(asset('/public/admin/clip-one/assets/sponsorship/thumbnail')); ?>/<?php echo e($productImage->image); ?>" alt="" class="product-edit-img"> 
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\D&NGroup\resources\views/admin/sponsorship/edit.blade.php ENDPATH**/ ?>