            ...
            <div class="col-md-12">
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">Edit <small>Career</small></h3>
                  </div>
                  ...
                  <?php endif; ?>
                  <form id="quickForm" action="<?php echo e(route('career.update')); ?>" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="card-footer">
                        <div>
                           ...
                           <a href="<?php echo e(route('career.index')); ?>" class="btn btn-default btn-secondary">Back</a>
                        </div>
                     </div>
                  </form>
               </div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\D&NGroup\resources\views/admin/career/edit.blade.php ENDPATH**/ ?>