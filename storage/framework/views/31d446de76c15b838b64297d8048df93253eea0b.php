         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Privacy Policy Edit</li>
               </ol>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-12">
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">Edit <small>Privacy Policy</small></h3>
                  </div>
                  ...
                  <?php endif; ?>
                  <form id="quickForm" action="<?php echo e(route('privacy_policy.update')); ?>" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="card-footer">
                        <div>
                           ...
                           <a href="<?php echo e(route('privacy_policy.index')); ?>" class="btn btn-default btn-secondary">Back</a>
                        </div>
                     </div>
                  </form>
               </div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/get-solutionweb/resources/views/admin/homepage/edit.blade.php ENDPATH**/ ?>