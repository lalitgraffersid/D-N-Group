         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card card-primary">
                  ...
                  <?php endif; ?>
                  <form id="quickForm" action="<?php echo e(route('roles.update')); ?>" method="POST">
                        ...
                        <div class="form-group">
                           ...
                           <select name="section_id" class="section_id select12 form-control" id="section_id" data-placeholder="Select a Section" style="width: 100%;" >
                              ...
                              <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <option value="<?php echo e($section->id); ?>" <?php if($section->id == $role->section_id){echo "selected";} ?>><?php echo e($section->section_title); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           </select>
                        </div>
                        <div class="form-group">
                           ...
                           <select name="action_id[]" class="action_id select12 form-control" id="action_id" data-placeholder="Select a Section" style="width: 100%;" multiple="multiple">
                              ...
                              <?php $__currentLoopData = $actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <option value="<?php echo e($action->id); ?>" <?php if(in_array($action->id,$roleActions)){echo "selected";} ?> ><?php echo e($action->action_title); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           </select>
                        </div>
                        <div class="form-group">
                           <label for="action_title">Role Name</label>
                           <input type="text" name="name" value="<?php echo e($role->name); ?>" class="form-control" id="action_title" placeholder="Role name">
                        </div>
                     </div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/DNGroup/resources/views/admin/role/edit.blade.php ENDPATH**/ ?>