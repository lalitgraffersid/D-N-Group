            ...
            <div class="col-lg-12"> 
              ...
              <?php endif; ?>
               ...
               <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form id="quickForm" role="form" action="<?php echo e(route('sub_admin.save')); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                 ...
                                 <div class="form-group clearfix" style="padding-left: 20px;">
                                    ...
                                    <input type="hidden" name="role_id<?php echo e($i); ?>" value="<?php echo e($rol->id); ?>">
                                       ...
                                       foreach($action_id as $actid){
                                          ...
                                          <div class="d-inline">
                                             <input type="checkbox" id="checkbox_<?php echo e($i); ?>" name="action_id<?php echo e($i); ?>[]" value="<?php echo e($actions->action_slug); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fjs_plant\resources\views/admin/sub_admin/add.blade.php ENDPATH**/ ?>