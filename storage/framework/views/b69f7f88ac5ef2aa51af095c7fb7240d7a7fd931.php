      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-footer">
              <div>
                 <a href="<?php echo e(route('sales_calls_report.index')); ?>" class="btn btn-primary btn-secondary float-sm-right">Back</a>
              </div>
           </div>
        </div>
        <!-- /.card-body -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fjs_plant\resources\views/admin/sales_calls_report/view.blade.php ENDPATH**/ ?>