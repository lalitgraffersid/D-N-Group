         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card card-primary">
                  ...
                  <?php endif; ?>
                  <form id="quickForm" action="<?php echo e(route('home_page.save')); ?>" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/DNGroup/resources/views/admin/home_page/add.blade.php ENDPATH**/ ?>