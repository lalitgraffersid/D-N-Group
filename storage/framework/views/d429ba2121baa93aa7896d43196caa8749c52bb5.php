         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card card-primary">
                  ...
                  <?php endif; ?>
                  <form id="quickForm" action="<?php echo e(route('sub_categories.update')); ?>" method="POST" enctype="multipart/form-data" >
                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           <?php if(!empty($result->image)): ?>
                              <img src="<?php echo e(asset('/public/admin/clip-one/assets/sub_categories/thumbnail')); ?>/<?php echo e($result->image); ?>" alt="" class="product-edit-img">
                           <?php endif; ?>
                     ...
                     <div class="card-footer">
                        <div>
                           ...
                           <a href="<?php echo e(route('sub_categories.index')); ?>" class="btn btn-default btn-secondary">Back</a>
                        </div>
                     </div>
                  </form>
               </div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\a1_solutions\resources\views/admin/sub_categories/edit.blade.php ENDPATH**/ ?>