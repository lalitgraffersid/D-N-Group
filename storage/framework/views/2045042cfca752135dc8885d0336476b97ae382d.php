    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
      <div class="service-box">
        <div class="service-img">
          <img src="<?php echo e(asset('/public/admin/clip-one/assets/category/original')); ?>/<?php echo e($ser->image); ?>" class="service-img-responsive">
        </div>
...
<?php echo $__env->make('front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/DNGroup/resources/views/front/service/index.blade.php ENDPATH**/ ?>