              ...
              <div class="card">
               ...
               <?php if(!empty($data['checkRole']) && (Auth::user()->user_type == 'admin' || !empty($data['checkPermission']))): ?>
                  <div class="card-header float-right">
                     <a href="<?php echo e(route('news.add')); ?>" class="btn btn-info float-right"><i class="fas fa-plus"></i> <?php echo e($data['actionData']->action_title); ?> </a>
                  </div>
               <?php endif; ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\a1_solutions\resources\views/admin/news/index.blade.php ENDPATH**/ ?>