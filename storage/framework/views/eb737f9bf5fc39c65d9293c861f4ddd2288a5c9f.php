...
<div class="wrapper">
 ...
 -->
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
         <a class="nav-link" data-toggle="dropdown" href="#">
            ...
            <span class="badge badge-danger navbar-badge"><?php echo e(count($lead_comments)); ?></span>
         </a>
            ...
            <a href="<?php echo e(route('leads.view',$lead_comment->id)); ?>" class="dropdown-item">
               ...
               <div class="media">
                  ...
                  <div class="media-body">
                     <h3 class="dropdown-item-title"><?php echo e($lead_comment->user_name); ?> commented on lead <?php echo e($lead_comment->lead_name); ?>

                        <span class="float-right text-sm text-danger"><i class="fas fa-star"></i></span>
                     </h3>
                     <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> <?php echo e($timeAgo); ?></p>
                  </div>
               </div>
               <!-- Message End -->
            </a>
      ...
      <li class="nav-item dropdown">
         <a class="nav-link" data-toggle="dropdown" href="#">
            ...
            <span class="badge badge-warning navbar-badge"><?php echo e($total); ?></span>
         </a>
         <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <span class="dropdown-item dropdown-header">Notifications</span>

            <div class="dropdown-divider"></div>
            <a href="<?php echo e(route('quotes.index')); ?>" class="dropdown-item">
               <i class="fas fa-envelope mr-2"></i> <?php echo e(count($quotes) >= 1 ? count($quotes) : 'No'); ?> new quotes
            </a>

            <div class="dropdown-divider"></div>
            <a href="<?php echo e(route('sales_order.index')); ?>" class="dropdown-item">
               <i class="fas fa-users mr-2"></i> <?php echo e(count($sales_orders) >= 1 ? count($sales_orders) : 'No'); ?> new sales order created
            </a>
  ...
  <!-- /.navbar --><?php /**PATH C:\xampp\htdocs\fjs_plant\resources\views/admin/includes/navbar.blade.php ENDPATH**/ ?>